...
public class FineSteelDustItem extends TesterModElements.ModElement {
	@ObjectHolder("tester:fine_steel_dust")
	public static final Item block = null;
	public FineSteelDustItem(TesterModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fine_steel_dust");
		}
