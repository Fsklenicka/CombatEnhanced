...
public class G36Item extends TesterModElements.ModElement {
	@ObjectHolder("tester:g_36")
	public static final Item block = null;
	@ObjectHolder("tester:entitybulletg_36")
	public static final EntityType arrow = null;
	public G36Item(TesterModElements instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletg_36").setRegistryName("entitybulletg_36"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(EnhancedcombatItemGroup.tab).maxDamage(1000));
			setRegistryName("g_36");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 10f, 7.9, 1);
