...
public class AmbrosiaBlock extends TesterModElements.ModElement {
	@ObjectHolder("tester:ambrosia")
	public static final Block block = null;
	public AmbrosiaBlock(TesterModElements instance) {
		super(instance, 11);
	}
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new TallBlockItem(block, new Item.Properties().group(EnhancedcombatItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
